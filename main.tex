...
\addbibresource[location=local]{mybibfile1.bib} % 如果在其他盘，改为相对路径。比如F盘，改为：F/MyLibrary.bib
...
\title{\vspace{-1.5cm} \bf\xiaoerhao 基于xxxx控制}
\author{\bf\sihao 作者姓名}
\date{}
...
\begin{document}
  ...
  \includepdf[pages={1-2}]{cover1.pdf} %记得改页码
\end{document}
